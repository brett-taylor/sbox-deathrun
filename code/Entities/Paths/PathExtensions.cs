...
{
	public static (Vector3 point, Vector3 normal) GetPointAndNormalBetweenNodes( this BasePathEntity path, PathNode start, PathNode end, float t, bool reverse = false )
	{
