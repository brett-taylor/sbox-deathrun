namespace SBoxDeathrun.Round
{
	public static class GameConfig
	{
		...
		public static readonly float FINISH_ROUND_LENGTH = 3f;

		public static readonly float DEATH_GROUND_FRICTION = 8f;
		...
		public static readonly float RUNNER_GROUND_FRICTION = 8f;
